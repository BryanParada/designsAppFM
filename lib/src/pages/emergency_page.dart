...
final items = <ItemButton>[
  ...
  new ItemButton( FontAwesomeIcons.plus, 'Medical Assistance', Color(0xff66A9F2), Color(0xff536CF6) ),
  new ItemButton( FontAwesomeIcons.masksTheater, 'Theft / harassment', Color(0xffF2D572), Color(0xffE06AA3) ),
